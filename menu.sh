...
sleep 0.5
echo $CYAN"[1] Instalar Bot-Ysaias-Ultimate"
sleep 0.5
...
if [ $opts = "1" ]; then
	...
	cd
	git clone https://github.com/Jshelbyy/ysaias-bot > /dev/null 2> /dev/null
	clear
	...
	echo
	echo $YELLOW "cd .. && cd ysaias-bot && npm start"
	echo
	echo $NC
fi
